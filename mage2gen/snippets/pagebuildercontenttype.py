    ...
    def add(self, content_type_name, field_name, extra_params=None):
                    ...
                    Xmlnode('appearances', nodes=[
                        Xmlnode('appearance', attributes={
                            ...
                            Xmlnode('elements', nodes=[
                                Xmlnode('element', attributes={'name': 'main'}, nodes=[
        ...
        ui_form = Xmlnode('form', attributes={
            ...
            Xmlnode('dataSource', attributes={'name': data_source}, nodes=[
                Xmlnode('argument', attributes={'name': 'data', 'xsi:type': 'array'}, nodes=[
                    Xmlnode('item', attributes={'name': 'js_config', 'xsi:type': 'array'}, nodes=[
                        Xmlnode('item', attributes={'name': 'component', 'xsi:type': 'string'}, node_text='Magento_PageBuilder/js/form/provider')
                    ]),
                ]),
            ...
            Xmlnode('fieldset', attributes={
                ...
                Xmlnode('settings', nodes=[
                    Xmlnode('label', attributes={'translate':'true'}, node_text='Appearance'),
                    Xmlnode('additionalClasses', nodes=[
                        Xmlnode('class', attributes={'name': 'admin__fieldset-visual-select-large'}, node_text='true'),
                    ]),
                ...
                Xmlnode('field', attributes={
                    ...
                    Xmlnode('argument', attributes={'name': 'data', 'xsi:type': 'array'}, nodes=[
                        Xmlnode('item', attributes={'name': 'config', 'xsi:type': 'array'}, nodes=[
                            Xmlnode('item', attributes={'name': 'default', 'xsi:type': 'string'}, node_text='default'),
                        ]),
                    ]),
                    Xmlnode('settings', nodes=[
                        Xmlnode('additionalClasses', nodes=[
                            Xmlnode('class', attributes={'name': 'admin__field-wide'}, node_text='true'),
                            Xmlnode('class', attributes={'name': 'admin__field-visual-select-container'}, node_text='true'),
                        ]),
                        Xmlnode('dataType', node_text='text'),
                        Xmlnode('validation', nodes=[
                            Xmlnode('rule', attributes={
                    ...
                    Xmlnode('formElements', nodes=[
                        Xmlnode('select', nodes=[
                            Xmlnode('settings', nodes=[
                                Xmlnode('options', attributes={
                                    'class': 'AppearanceSource{}'.format(upperfirst(content_type_name))
                                }),
                            ]),
                        ]),
                    ]),
            ...
            Xmlnode('fieldset', attributes={
                ...
                Xmlnode('field', attributes={
                        'name': '{}'.format(field_name), 'formElement': '{}'.format(field_element_type),
                        'sortOrder': str(10 * self.count)
                }, nodes=[
                    Xmlnode('argument', attributes={'name': 'data', 'xsi:type': 'array'}, nodes=[
                        Xmlnode('item', attributes={'name': 'config', 'xsi:type': 'array'}, nodes=[
                            Xmlnode('item', attributes={'name': 'source', 'xsi:type': 'string'}, node_text='page'),
                        ]),
                    ]),
                    Xmlnode('settings', nodes=[
                        Xmlnode('dataScope', node_text='{}'.format(field_name)),
                        Xmlnode('dataType', node_text='{}'.format(field_data_type)),
                        Xmlnode('label', attributes={'translate': 'false'}, node_text='{}'.format(field_label)),
                    ]),
                ]),
            ]),
        ])
        ...
        di_xml = Xmlnode('config', attributes={
            ...
            Xmlnode('virtualType', attributes={
                ...
                Xmlnode('arguments', nodes=[
                    ...
                    Xmlnode('argument', attributes={'name': 'optionsData', 'xsi:type': 'array'}, nodes=[
                        Xmlnode('item', attributes={'name': '0', 'xsi:type': 'array'}, nodes=[
